...
import { u as useAuth, h as useAudio, g as getTextLanguageClass, f as formatTimeAgo, e as formatDate, s as supabase } from "./server-build-3vQ7_HUN.js";
...
function PlayerPage() {
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      setLikeCount((prev) => newLikedState2 ? prev + 1 : Math.max(0, prev - 1));
      if (!newLikedState2) {
