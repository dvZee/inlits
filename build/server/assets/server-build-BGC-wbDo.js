...
import { AlertCircle, RefreshCw, RotateCcw, Lock, Loader2, Pause, Play, RotateCw, VolumeX, Volume2, Settings, List, X, SkipBack, SkipForward, Headphones, Car, Timer, Moon, Dumbbell, Zap, Check, Search, User, TrendingUp, History, Bell, BookOpen, Crown, Sun, ChevronDown, MoreHorizontal, Home as Home$1, Target, Library, CreditCard, BookMarked, MessageSquare, Users2, Trophy, ChevronRight, ChevronLeft, Newspaper, Mic, Sparkles, Mail, Star, Bookmark, FileText, Info } from "lucide-react";
...
const styles = "/assets/index-CISntCNQ.css";
...
function AudioPlayer({
  ...
  const isPremium = (profile == null ? void 0 : profile.subscription_status) === "active" || (profile == null ? void 0 : profile.role) === "creator";
  const isLocked = (currentAudio == null ? void 0 : currentAudio.type) === "audiobook" && currentChapter > 0 && !isPremium;
  React__default.useEffect(() => {
  ...
  React__default.useEffect(() => {
    ...
    const handleEnded = () => {
      if ((currentAudio == null ? void 0 : currentAudio.chapters) && currentChapter < currentAudio.chapters.length - 1) {
        ...
        const isNextChapterPremium = (profile == null ? void 0 : profile.subscription_status) === "active" || (profile == null ? void 0 : profile.role) === "creator";
        ...
        isMobileView ? /* @__PURE__ */ jsx("div", { className: "px-2 py-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 flex-shrink-0", children: [
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                onClick: togglePlay,
                disabled: !isLocked && (isLoading || !(currentAudio == null ? void 0 : currentAudio.audioUrl) && !((currentAudio == null ? void 0 : currentAudio.chapters) && currentAudio.chapters.length > 0)),
                ...
                children: isLocked ? /* @__PURE__ */ jsx(Lock, { className: "w-5 h-5 text-amber-300" }) : isLoading ? /* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 animate-spin" }) : contextIsPlaying ? /* @__PURE__ */ jsx(Pause, { className: "w-5 h-5" }) : /* @__PURE__ */ jsx(Play, { className: "w-5 h-5 ml-0.5" })
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-4 flex-1", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: isLocked ? /* @__PURE__ */ jsx(Lock, { className: "w-6 h-6 text-amber-300" }) : isLoading ? /* @__PURE__ */ jsx(Loader2, { className: "w-6 h-6 animate-spin" }) : contextIsPlaying ? /* @__PURE__ */ jsx(Pause, { className: "w-6 h-6" }) : /* @__PURE__ */ jsx(Play, { className: "w-6 h-6 ml-0.5" })
              }
            ),
            playlist.length > 1 && /* @__PURE__ */ jsx(
              "button",
                ...
                showPlaylist && (currentAudio == null ? void 0 : currentAudio.chapters) && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full right-0 mb-2 w-80 bg-popover border rounded-lg shadow-xl max-h-96 overflow-hidden flex flex-col", children: [
                  ...
                  currentAudio.chapters.length > 1 && /* @__PURE__ */ jsx("div", { className: "overflow-y-auto flex-1", children: /* @__PURE__ */ jsxs("div", { className: "p-2 space-y-1", children: [
                    ...
                    currentAudio.chapters.map((chapter, index) => {
                      const isPremium2 = (profile == null ? void 0 : profile.subscription_status) === "active" || (profile == null ? void 0 : profile.role) === "creator";
                      const isChapterLocked = currentAudio.type === "audiobook" && index > 0 && !isPremium2;
                      ...
                      return /* @__PURE__ */ jsxs(
                        "button",
                        {
                          ...
                          className: `w-full flex items-center justify-between p-2 rounded text-sm transition-all ${isChapterLocked ? "bg-muted/35 hover:bg-accent/10 cursor-pointer opacity-80" : isCurrent ? "bg-primary text-primary-foreground" : "hover:bg-accent"}`,
                          disabled: isLoading,
                          children: [
                            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 min-w-0 flex-1", children: [
                              /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: isChapterLocked ? /* @__PURE__ */ jsx(Lock, { className: "w-3 h-3 text-amber-500" }) : isLoading && isCurrent ? /* @__PURE__ */ jsx(Loader2, { className: "w-3 h-3 animate-spin" }) : isCurrent && contextIsPlaying ? /* @__PURE__ */ jsx(Pause, { className: "w-3 h-3" }) : /* @__PURE__ */ jsx(Play, { className: "w-3 h-3" }) }),
...
function GlobalAudioPlayer() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("audio", { ref: audioRef, className: "hidden", preload: "auto" }),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-3xl -mr-16 -mt-16" }),
              /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-32 h-32 bg-primary/10 rounded-full blur-3xl -ml-16 -mb-16" }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: () => setShowUpgradeModal(false),
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-center space-y-6 relative", children: [
                /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-full bg-gradient-to-tr from-amber-500 to-yellow-400 flex items-center justify-center mx-auto shadow-lg shadow-amber-500/25 transform hover:scale-105 transition-all", children: /* @__PURE__ */ jsx(Lock, { className: "w-7 h-7 text-white fill-current" }) }),
                /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold tracking-tight text-foreground", children: "Continue Your Journey of Growth" }),
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "This chapter is part of Inlits Premium. When you upgrade, you're not just buying a subscription—you're investing in your own daily potential and expanding your intellectual horizons." }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-500/90 font-medium", children: "By joining, you directly support independent authors and narrators who bring these ideas to life." })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "bg-muted/40 border border-border/50 rounded-xl p-5 text-left space-y-3.5", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-5 h-5 rounded-full bg-amber-500/10 flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsx(Check, { className: "w-3.5 h-3.5 text-amber-500" }) }),
                    /* @__PURE__ */ jsxs("div", { className: "text-sm text-muted-foreground", children: [
                      /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: "Daily Self-Investment" }),
                      " — Build a lifelong habit of learning with unlimited access to premium summaries and audiobooks."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-5 h-5 rounded-full bg-amber-500/10 flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsx(Check, { className: "w-3.5 h-3.5 text-amber-500" }) }),
                    /* @__PURE__ */ jsxs("div", { className: "text-sm text-muted-foreground", children: [
                      /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: "Empower Global Thinkers" }),
                      " — Directly fund the research, translation, and production of world-changing ideas."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-5 h-5 rounded-full bg-amber-500/10 flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsx(Check, { className: "w-3.5 h-3.5 text-amber-500" }) }),
                    /* @__PURE__ */ jsxs("div", { className: "text-sm text-muted-foreground", children: [
                      /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: "Clarity of Mind" }),
                      " — Completely ad-free, high-quality audio experience designed to respect your focus."
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2.5 pt-2", children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: () => {
                  ...
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      children: "Return to Free Chapter"
                    }
                  )
                ] })
              ] })
  ...
  const getContentLabel = () => {
    switch (item.type) {
      case "audiobook":
        ...
        return { icon: Headphones, label: "Full Book" };
      case "ebook":
        if (item.is_full_book === false) {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-CYEob11G.js", "imports": ["/assets/supabase-DhpF_sb_.js", "/assets/query-cache-C18JZZse.js", "/assets/components-Bzj6Th3V.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-Beq5DHdG.js", "imports": ["/assets/supabase-DhpF_sb_.js", "/assets/query-cache-C18JZZse.js", "/assets/components-Bzj6Th3V.js", "/assets/auth-CCnhm_OR.js", "/assets/rotate-cw-hMFmgge8.js", "/assets/lock-BefoK3An.js", "/assets/pause-DBxlby0A.js", "/assets/list-Ru-HZFLu.js", "/assets/zap-DC2Owvfy.js", "/assets/check-DvaKCscX.js"], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-Cn70dpOH.js", "imports": ["/assets/supabase-DhpF_sb_.js", "/assets/home-DMT2mDg1.js", "/assets/components-Bzj6Th3V.js", "/assets/auth-CCnhm_OR.js", "/assets/query-cache-C18JZZse.js"], "css": [] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_-CxkED4G6.js", "imports": ["/assets/supabase-DhpF_sb_.js", "/assets/home-DMT2mDg1.js", "/assets/auth-CCnhm_OR.js", "/assets/query-cache-C18JZZse.js"], "css": [] } }, "url": "/assets/manifest-f70d8009.js", "version": "f70d8009" };
