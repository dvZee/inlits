...
const styles = "/assets/index-cnmYPqE9.css";
...
function AudioProvider({
  ...
  const [currentTrackIndex, setCurrentTrackIndex2] = useState(0);
  ...
  const playNext = () => {
    ...
    if (nextTrack) {
      setCurrentTrackIndex2(nextIndex);
      playAudio2(nextTrack);
    }
  };
  const playPrevious = () => {
    if (playlist.length === 0) return;
    ...
    if (prevTrack) {
      setCurrentTrackIndex2(prevIndex);
      playAudio2(prevTrack);
    }
  };
  const playAudio2 = (audio) => {
  ...
  useEffect(() => {
    try {
      ...
      if (savedState) {
        ...
        setCurrentTrackIndex2(state.currentTrackIndex || 0);
      }
    } catch (error) {
  ...
  return /* @__PURE__ */ jsx(AudioContext.Provider, { value: {
    ...
    setPlaylist,
    currentTrackIndex,
    setCurrentTrackIndex: setCurrentTrackIndex2,
    playNext,
    playPrevious,
      ...
      children: [
        ...
        isMobileView ? /* @__PURE__ */ jsx("div", { className: "px-2 py-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 flex-shrink-0", children: [
            ...
            ((currentAudio == null ? void 0 : currentAudio.chapters) && currentAudio.chapters.length > 1 || playlist.length > 1) && /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => {
                ...
                disabled: isLoading,
                title: playlist.length > 1 ? "Queue" : "Chapters",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 flex-shrink-0 justify-end w-80", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              (currentAudio == null ? void 0 : currentAudio.chapters) && currentAudio.chapters.length > 1 && /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                showPlaylist && ((currentAudio == null ? void 0 : currentAudio.chapters) || playlist.length > 1) && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full right-0 mb-2 w-80 bg-popover border rounded-lg shadow-xl max-h-96 overflow-hidden flex flex-col", children: [
                  /* @__PURE__ */ jsx("div", { className: "p-3 border-b", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsx("h3", { className: "font-medium text-sm", children: playlist.length > 1 ? "Queue" : "Chapters" }),
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                  ...
                  playlist.length > 1 && /* @__PURE__ */ jsx("div", { className: "overflow-y-auto flex-1", children: /* @__PURE__ */ jsxs("div", { className: "p-2 space-y-1", children: [
                    ...
                    playlist.map((track, index) => {
                      ...
                      return /* @__PURE__ */ jsxs(
                        "button",
                        {
                          ...
                          className: `w-full flex items-center gap-2 p-2 rounded text-sm transition-all ${isCurrent ? "bg-primary text-primary-foreground" : "hover:bg-accent"}`,
                          children: [
                            /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-10 h-10 rounded overflow-hidden bg-muted", children: /* @__PURE__ */ jsx(
                              "img",
                              {
                                src: track.thumbnail,
                                alt: track.title,
                                className: "w-full h-full object-cover",
                                onError: (e) => {
                                  e.currentTarget.src = "https://placehold.co/40x40?text=Track";
                                }
                              }
                            ) }),
                            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 text-left", children: [
                              /* @__PURE__ */ jsx("div", { className: "font-medium line-clamp-1", children: track.title }),
                              /* @__PURE__ */ jsx("div", { className: "text-xs opacity-70 line-clamp-1", children: track.author })
                            ] }),
                            isCurrent && /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: contextIsPlaying ? /* @__PURE__ */ jsx(Pause, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(Play, { className: "w-4 h-4" }) })
                          ]
                        },
                        `${track.type}-${track.id}`
                      );
                  ...
                  (currentAudio == null ? void 0 : currentAudio.chapters) && currentAudio.chapters.length > 1 && /* @__PURE__ */ jsx("div", { className: "overflow-y-auto flex-1 border-t", children: /* @__PURE__ */ jsxs("div", { className: "p-2 space-y-1", children: [
                    /* @__PURE__ */ jsxs("div", { className: "text-xs font-medium text-muted-foreground px-2 py-1", children: [
                      "Chapters (",
                      currentAudio.chapters.length,
                      ")"
        ...
        isMobileView && showPlaylist && ((currentAudio == null ? void 0 : currentAudio.chapters) || playlist.length > 1) && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full left-0 right-0 mb-2 mx-3 bg-popover border rounded-lg shadow-xl max-h-96 overflow-hidden flex flex-col", children: [
          /* @__PURE__ */ jsx("div", { className: "p-3 border-b", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-medium text-sm", children: playlist.length > 1 ? "Queue" : "Chapters" }),
            /* @__PURE__ */ jsx(
              "button",
...
function HeroBanner({ items }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative w-full h-[50vh] md:h-[60vh] lg:h-[70vh] min-h-[400px] md:min-h-[500px] max-h-[600px] md:max-h-[700px] overflow-hidden rounded-xl shadow-2xl mb-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
      currentItem.thumbnail && currentItem.thumbnail.length > 0 ? /* @__PURE__ */ jsx(
        "img",
        {
          ...
          onError: (e) => {
            ...
            if (parent) {
              ...
              gradientDiv.className = "w-full h-full bg-gradient-to-br from-primary/30 via-primary/20 to-background";
              parent.insertBefore(gradientDiv, parent.firstChild);
            }
          }
        }
      ) : /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gradient-to-br from-primary/30 via-primary/20 to-background" }),
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-black/90 via-black/60 to-transparent" }),
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "relative h-full flex flex-col justify-end p-4 md:p-12 lg:p-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl space-y-4", children: [
      ...
      /* @__PURE__ */ jsx(
        "h1",
        {
          className: `text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight ${getTextLanguageClass(
            currentItem.title
          )}`,
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full overflow-hidden bg-white/10", children: /* @__PURE__ */ jsx(
              "img",
              {
                ...
                onError: (e) => {
                  const target = e.currentTarget;
                  target.src = "https://placehold.co/80x80?text=U";
                }
              }
            ) }),
...
function CinematicCollections() {
  ...
  const [loading, setLoading] = useState(true);
  const { setPlaylist, setCurrentTrackIndex: setCurrentTrackIndex2, playAudio: playAudio2 } = useAudio();
  useEffect(() => {
  ...
  const handleCollectionClick = async (collection) => {
    try {
      ...
      if (playlistItems.length > 0) {
        ...
        setCurrentTrackIndex2(0);
        playAudio2(playlistItems[0]);
      }
    } catch (error) {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-CfBJ5VaK.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/query-cache-C18JZZse.js", "/assets/components-CmcuS0ao.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-DOOZnWWF.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/query-cache-C18JZZse.js", "/assets/components-CmcuS0ao.js", "/assets/auth-4kXjtv3T.js", "/assets/refresh-cw-CGnP0dSO.js", "/assets/pause-CvQsMLcm.js", "/assets/list-BkFp6vYD.js", "/assets/lock-D3uOZcTM.js", "/assets/zap-BjikLAI2.js"], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-q56-Dy9O.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/home-CupalmLV.js", "/assets/components-CmcuS0ao.js", "/assets/auth-4kXjtv3T.js", "/assets/query-cache-C18JZZse.js"], "css": [] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_-K0CTIWUh.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/home-CupalmLV.js", "/assets/auth-4kXjtv3T.js", "/assets/query-cache-C18JZZse.js"], "css": [] } }, "url": "/assets/manifest-7c732590.js", "version": "7c732590" };
