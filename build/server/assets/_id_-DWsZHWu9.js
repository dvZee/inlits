...
import { u as useAuth, e as useAudio, g as getTextLanguageClass, f as formatTimeAgo, c as formatDate, s as supabase } from "./server-build-yCr6HHQW.js";
...
function PlayerPage() {
  ...
  const handleRating = async (rating) => {
    ...
    try {
      ...
      setUserRating((content == null ? void 0 : content.user_rating) ?? 0);
    }
  };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background pb-32 pt-8", children: [
    /* @__PURE__ */ jsx("div", { className: "container max-w-7xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: `text-center lg:text-left px-4 lg:px-0`, children: /* @__PURE__ */ jsx("h1", { className: `text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight text-foreground reader-title ${getTextLanguageClass(content.title)}`, children: content.title }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 sm:gap-2 flex-shrink-0", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                title: "Like",
                children: [
                  /* @__PURE__ */ jsx(Heart, { className: `w-4 h-4 ${isLiked ? "fill-current" : ""}` }),
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                title: "Save",
                children: /* @__PURE__ */ jsx(Bookmark, { className: `w-4 h-4 ${isBookmarked ? "fill-current" : ""}` })
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
        ...
        /* @__PURE__ */ jsx("hr", {}),
        /* @__PURE__ */ jsx("div", { className: `px-4 lg:px-0`, children: /* @__PURE__ */ jsx("p", { className: `text-sm sm:text-base text-muted-foreground leading-relaxed reader-content ${getTextLanguageClass(content.description)}`, children: content.description }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-4", children: comments.length > 0 ? comments.map((comment) => {
            ...
            return /* @__PURE__ */ jsx("div", { className: "space-y-3", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2 sm:gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                comment.replies && comment.replies.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-4 space-y-3", children: comment.replies.map((reply) => /* @__PURE__ */ jsxs("div", { className: "flex gap-2 ml-4 pl-4 border-l-2 border-muted", children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
