...
import { u as useAuth } from "./server-build-yCr6HHQW.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "container max-w-6xl mx-auto px-4 py-8", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-8", children: plans.map((plan) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            plan.popular && /* @__PURE__ */ jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-primary text-primary-foreground text-xs font-medium rounded-full", children: "Most Popular" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-card border rounded-lg p-6 mb-8", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold mb-6 text-center", children: "Unlocking All Content" }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsx(Crown, { className: "w-5 h-5 text-primary" }),
              /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: "Premium" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Ad-free & Unlimited Content" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "HD Video Quality" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Stream on up to 5 devices" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Includes Casting & PIP" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Offline downloads" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Priority support" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsx(Zap, { className: "w-5 h-5 text-muted-foreground" }),
              /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: "Free" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Limited Content Access" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Standard Video Quality" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Include Advertisements" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-green-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Limited Features" })
              ] })
            ] })
          ] })
        ] })
