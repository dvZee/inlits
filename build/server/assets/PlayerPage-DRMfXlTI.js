...
import { u as useAuth, h as useAudio, g as getTextLanguageClass, f as formatTimeAgo, e as formatDate, s as supabase } from "./server-build-BGC-wbDo.js";
          ...
          const formattedComments = commentsData.filter((comment) => !comment.parent_id).map((comment) => {
            ...
            return {
              ...
              user: {
                ...
                username: (profile2 == null ? void 0 : profile2.username) || "anonymous",
                avatar_url: (profile2 == null ? void 0 : profile2.avatar_url) || `https://source.unsplash.com/random/100x100?face&sig=${comment.user_id}`
              },
