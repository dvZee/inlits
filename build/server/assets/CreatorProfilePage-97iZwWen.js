...
import { w as withRetry, s as supabase, I as ImageLoader, u as useAuth, g as getTextLanguageClass } from "./server-build-yCr6HHQW.js";
import { Loader2, AlertCircle, Upload, X, Image, Send, MessageSquare, Bell, Share2, ChevronLeft, ChevronRight, Star, Filter, ArrowUpDown, Clock, Download, Lock, Headphones, Pause, Play, BookOpen, Eye, Calendar, FileText, Mic } from "lucide-react";
import "node:stream";
import "isbot";
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-6 items-start", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col w-full md:hidden items-center", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center mt-4", children: [
            ...
            (!user || user.id !== profile.id) && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-3", children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: handleFollow,
                  className: `px-3 py-1.5 rounded-full text-sm font-medium transition-colors whitespace-nowrap ${isFollowing ? "bg-primary/10 text-primary hover:bg-primary hover:text-white" : "bg-primary text-white hover:bg-primary/90"}`,
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-start gap-4 flex-1", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
              ...
              (!user || user.id !== profile.id) && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: handleFollow,
...
function CreatorHome({ profile, recentContent }) {
  const navigate = useNavigate();
  const recentItems = [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxs("section", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold mb-6", children: "Recently Posted" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6", children: recentItems.map((item) => {
        var _a;
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "aspect-[2/3] rounded-lg overflow-hidden bg-muted", children: /* @__PURE__ */ jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground mb-2", children: [
                  ...
                  item.series_id && /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx("span", { children: "•" }),
                    /* @__PURE__ */ jsx("span", { className: "text-primary", children: "Part of a Series" })
                  ] }),
                  /* @__PURE__ */ jsx("span", { children: "•" }),
                  /* @__PURE__ */ jsx("span", { children: new Date(item.created_at).toLocaleDateString() })
                ] }),
                /* @__PURE__ */ jsx("h3", { className: `text-base font-medium line-clamp-2 group-hover:text-primary transition-colors ${getTextLanguageClass(item.title)}`, children: item.title }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mt-2 text-sm", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                    /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-yellow-500 text-yellow-500" }),
                    /* @__PURE__ */ jsx("span", { children: ((_a = item.rating) == null ? void 0 : _a.toFixed(1)) || "0.0" })
                  ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6", children: Array.from(seriesIds).map((seriesId, index) => {
        ...
        return /* @__PURE__ */ jsx("div", { className: "group space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "aspect-[2/3] relative rounded-lg overflow-hidden bg-muted", children: [
          /* @__PURE__ */ jsx(
            "img",
            {
              src: (firstItem == null ? void 0 : firstItem.cover_url) || `https://source.unsplash.com/random/800x1200?books&sig=${seriesId}`,
              alt: "Series Cover",
              className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
            }
          ),
  ...
  useEffect(() => {
    const loadCreatorData = async () => {
      ...
      try {
        ...
        const profileRole = profileData.role ?? "consumer";
        ...
        const { data: creatorData2, error: creatorError } = await supabase.rpc("get_creator_profile", { username: actualUsername });
        if (creatorError) {
        ...
        if (!(creatorData2 == null ? void 0 : creatorData2[0])) {
          ...
          setDebugInfo((prev) => ({ ...prev ?? {}, creator_data: creatorData2 }));
          throw new Error("Failed to load creator data");
        }
        console.log("Creator data loaded:", creatorData2[0]);
