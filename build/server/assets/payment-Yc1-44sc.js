...
import { ArrowLeft, Check, CreditCard, AlertCircle, Shield, Loader2, Lock, Smartphone, Wallet } from "lucide-react";
    ...
    try {
      ...
      const paymentRequest = {
        ...
        ...method.type === "wallet" && {
          ...
          // Different IDs for different wallets
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
        ...
        selectedMethod && /* @__PURE__ */ jsxs("div", { className: "bg-card border rounded-lg p-6", children: [
          ...
          selectedMethod.type === "card" && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "cnic", children: "CNIC Number" }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "cnic",
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Required for verification purposes" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-500/10 to-green-500/10 border border-blue-500/20 rounded-lg p-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-lg bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center", children: /* @__PURE__ */ jsx(CreditCard, { className: "w-8 h-8 text-white" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "font-semibold text-lg", children: "Exclusive Discounts On Bank Cards" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "UPTO 70% Off" }),
            /* @__PURE__ */ jsx("button", { className: "text-sm text-primary hover:underline mt-1", children: "View Details" })
          ] })
        ] }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-muted/30 border rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Your payment information is encrypted and processed securely by PayFast." })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(
          "button",
