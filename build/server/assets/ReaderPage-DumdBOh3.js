...
import { c as useTheme, d as detectUrduText, g as getTextLanguageClass, u as useAuth, e as formatDate, s as supabase } from "./server-build-CUWZnfIj.js";
import { FileText, RefreshCw, Minimize2, Maximize2, ExternalLink, Download, Loader2, AlertCircle, ChevronLeft, ChevronRight, ZoomOut, ZoomIn, RotateCw, ArrowLeft, Menu, Settings, Bookmark, BookOpen, X, Minus, Plus, Sun, Moon, AlignLeft, Type, Highlighter, StickyNote, Share, Heart, MessageSquare, Share2, Twitter, Facebook, Linkedin, Check, Copy, Send, ThumbsUp, Reply, ChevronUp } from "lucide-react";
