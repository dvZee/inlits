...
function SignUpPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "container max-w-[400px] mx-auto px-4 py-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "text-center pt-6 border-t", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-3", children: "Want to share your knowledge and earn money?" }),
      /* @__PURE__ */ jsx(
        Link,
        {
          to: "/become-creator",
          className: "inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-colors",
