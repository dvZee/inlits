...
import React__default, { createContext, useContext, useState, useEffect, useRef, Suspense, memo, useCallback, useMemo } from "react";
import { createClient } from "@supabase/supabase-js";
import { AlertCircle, RefreshCw, Play, SkipBack, RotateCcw, Loader2, Pause, RotateCw, SkipForward, VolumeX, Volume2, Settings, List, X, Headphones, Car, Timer, Moon, Dumbbell, Lock, Zap, Search, User, TrendingUp, History, Bell, BookOpen, Crown, Sun, ChevronDown, MoreHorizontal, Home as Home$1, Target, Library, CreditCard, BookMarked, MessageSquare, Users2, Trophy, ChevronRight, ChevronLeft, Newspaper, Mic, Sparkles, Mail, Info, FileText, Star, Bookmark } from "lucide-react";
...
const styles = "/assets/index-DFmdzAS0.css";
const isBrowser$5 = typeof window !== "undefined";
const safeStorage$2 = isBrowser$5 && typeof window.localStorage !== "undefined" ? window.localStorage : {
  get length() {
    return 0;
  },
  key: () => null,
...
const hasImageConstructor = isBrowser$3 && typeof window.Image !== "undefined";
isBrowser$3 && typeof window.requestIdleCallback === "function" ? window.requestIdleCallback.bind(window) : (cb) => {
...
function useLazyImage(src, lowQualityUrl) {
  ...
  useEffect(() => {
    ...
    if (!isBrowser$3 || !hasImageConstructor || !src) return;
    const img = new Image();
    img.src = src;
    const handleLoad = () => {
...
function ImageLoader({
  ...
  const supportsIntersectionObserver = isBrowser2 && typeof window.IntersectionObserver !== "undefined";
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
    ...
    shouldLoad && !isLoaded && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-muted/30", children: /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full bg-muted animate-pulse" }) })
  ] });
}
...
function AudioPlayer({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `fixed left-0 right-0 bg-background/95 backdrop-blur-sm border-t shadow-lg z-40 ${isMobile ? "bottom-20" : "bottom-0 h-20"}`, children: [
    ...
    isMobile ? /* @__PURE__ */ jsxs("div", { className: "px-2 py-1 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 min-w-0 flex-1", children: [
        /* @__PURE__ */ jsx(
          Link,
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "w-6 h-6 rounded overflow-hidden bg-muted", children: /* @__PURE__ */ jsx(
              ImageLoader,
              {
                src: thumbnail,
                alt: title,
        ...
        /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              children: /* @__PURE__ */ jsxs("h3", { className: "font-medium text-xs line-clamp-1", children: [
                title.slice(0, 5),
                "..."
              ] })
            }
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-4 flex-1", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: isLoading ? /* @__PURE__ */ jsx(Loader2, { className: "w-6 h-6 animate-spin" }) : isPlaying ? /* @__PURE__ */ jsx(Pause, { className: "w-6 h-6" }) : /* @__PURE__ */ jsx(Play, { className: "w-6 h-6 ml-0.5" })
          }
        ),
        /* @__PURE__ */ jsx(
          "button",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 flex-shrink-0 justify-end w-80", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          (currentAudio == null ? void 0 : currentAudio.chapters) && currentAudio.chapters.length > 1 && /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            showPlaylist && (currentAudio == null ? void 0 : currentAudio.chapters) && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full right-0 mb-2 w-72 bg-popover border rounded-lg shadow-xl max-h-80 overflow-hidden", children: [
...
function GlobalAudioPlayer() {
  ...
  return /* @__PURE__ */ jsx("audio", { ref: audioRef, className: "hidden" });
}
const meta = () => [
  { charSet: "utf-8" },
  { title: "Inlits" },
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur-xl supports-[backdrop-filter]:bg-background/80 shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "container flex h-16 items-center justify-between px-4 md:px-6", children: [
...
function HeroBanner({ items }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative w-full h-[50vh] md:h-[60vh] lg:h-[70vh] min-h-[400px] md:min-h-[500px] max-h-[600px] md:max-h-[700px] overflow-hidden rounded-lg mb-8", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "relative h-full flex flex-col justify-end p-8 md:p-12 lg:p-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
        /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-primary/90 text-white rounded-full font-medium", children: "Featured" }),
        currentItem.category && /* @__PURE__ */ jsx("span", { className: "text-white/80", children: currentItem.category })
      ] }),
      /* @__PURE__ */ jsx("h1", { className: `text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight ${getTextLanguageClass(currentItem.title)}`, children: currentItem.title }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-sm text-white/80", children: [
        currentItem.rating && currentItem.rating > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-yellow-400", children: "★" }),
            /* @__PURE__ */ jsx("span", { children: currentItem.rating.toFixed(1) })
          ] }),
          /* @__PURE__ */ jsx("span", { children: "•" })
        ] }),
        currentItem.duration && /* @__PURE__ */ jsx("span", { children: currentItem.duration }),
        currentItem.views > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("span", { children: "•" }),
          /* @__PURE__ */ jsxs("span", { children: [
      ...
      currentItem.creator && /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full overflow-hidden bg-white/10", children: /* @__PURE__ */ jsx(
              ImageLoader,
              {
            ...
            /* @__PURE__ */ jsx("span", { className: "text-white font-medium", children: currentItem.creator.name })
          ]
        }
      ),
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { children: currentItem.type === "article" || currentItem.type === "ebook" ? "Read" : "Play" })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "More Info" })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-4 right-4 flex gap-2", children: featuredItems.map((_, index) => /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => {
          if (!isTransitioning) {
        ...
        className: `h-1 rounded-full transition-all ${index === currentIndex ? "w-8 bg-white" : "w-4 bg-white/50 hover:bg-white/70"}`
      },
      index
    )) })
  ] });
...
const ContentCard = memo(function ContentCard2({ item, activeShelf, onAddToShelf }) {
  ...
  const creatorLowQuality = getLowQualityUrl((_a = item.creator) == null ? void 0 : _a.avatar, 20);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: `relative ${getAspectRatio()}`, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute top-2 left-2 px-2.5 py-1.5 rounded-full bg-black/80 backdrop-blur-sm text-white text-xs font-semibold flex items-center gap-1.5 shadow-lg border border-white/10", children: [
            /* @__PURE__ */ jsx(ContentIcon, { className: "w-3.5 h-3.5" }),
            /* @__PURE__ */ jsx("span", { children: contentLabel.label })
          ] }),
          (item.type === "audiobook" || item.type === "podcast") && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/50 transition-all duration-300", children: /* @__PURE__ */ jsx("div", { className: "w-14 h-14 rounded-full bg-white flex items-center justify-center opacity-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 shadow-lg", children: /* @__PURE__ */ jsx(Play, { className: "w-7 h-7 text-black ml-1 fill-current" }) }) })
        ] }),
...
function ContentCarousel({ title, items, activeShelf, onAddToShelf }) {
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: items.map((item) => /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-[150px] sm:w-[160px] md:w-[180px] lg:w-[200px]", children: /* @__PURE__ */ jsx(
            ContentCard,
            {
              item,
              activeShelf,
...
function SmartRecommendations({ currentContent }) {
  const { user } = useAuth();
...
function HeroBannerSkeleton() {
  return /* @__PURE__ */ jsxs("div", { className: "relative w-full h-[70vh] min-h-[500px] max-h-[700px] overflow-hidden rounded-lg mb-8 animate-pulse", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-muted" }),
    /* @__PURE__ */ jsx("div", { className: "relative h-full flex flex-col justify-end p-8 md:p-12 lg:p-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl space-y-4", children: [
      /* @__PURE__ */ jsx("div", { className: "h-6 bg-muted/50 rounded w-32" }),
      /* @__PURE__ */ jsx("div", { className: "h-16 bg-muted/50 rounded w-3/4" }),
      /* @__PURE__ */ jsx("div", { className: "h-4 bg-muted/50 rounded w-1/2" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pt-4", children: [
        /* @__PURE__ */ jsx("div", { className: "h-12 bg-muted/50 rounded w-32" }),
        /* @__PURE__ */ jsx("div", { className: "h-12 bg-muted/50 rounded w-32" })
      ] })
    ] }) })
  ] });
...
function Home({ selectedCategory = "all", initialData }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("Failed to restore home content cache:", error2);
    }
  }, []);
  useEffect(() => {
    if (!shelfParam) {
      ...
      try {
        ...
        const [audiobooksResult, booksResult, podcastsResult] = await Promise.all([
          ...
          supabase.from("podcast_episodes").select(`
            ...
            `).eq("status", "published").order("featured", { ascending: false }).order("created_at", { ascending: false }).limit(20)
        ]);
        ...
        console.log("Raw data loaded:", {
          ...
          podcasts: ((_c = podcastsResult.data) == null ? void 0 : _c.length) || 0
        });
        let userBookmarks = [];
        if (user) {
        ...
        const normalizeAuthor = (author, fallbackId) => {
          ...
          const initial = ((_a2 = name[0]) == null ? void 0 : _a2.toUpperCase()) || "U";
          return {
        ...
        const audiobooks = await Promise.all((audiobooksResult.data || []).map(async (item) => ({
          ...
          type: "audiobook",
          title: item.title,
          thumbnail: item.cover_url && item.cover_url.trim().length > 0 ? item.cover_url : getPlaceholderThumbnail("audiobook"),
          duration: "2 hours",
        ...
        const books = await Promise.all((booksResult.data || []).map(async (item) => ({
          ...
          type: "ebook",
          title: item.title,
          thumbnail: item.cover_url && item.cover_url.trim().length > 0 ? item.cover_url : getPlaceholderThumbnail("ebook"),
          duration: "4 hours",
        ...
        const podcasts = await Promise.all((podcastsResult.data || []).map(async (item) => ({
          ...
          type: "podcast",
          title: item.title,
          thumbnail: item.cover_url && item.cover_url.trim().length > 0 ? item.cover_url : getPlaceholderThumbnail("podcast"),
          duration: item.duration,
  ...
  if (loading && !initialLoadComplete) {
    return /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsx(HeroBannerSkeleton, {}),
  ...
  const popularThisMonth = allContentItems.filter((item) => new Date(item.createdAt) >= thisMonthDate).sort((a, b) => b.views - a.views).slice(0, 15);
  const newReleases = allContentItems.sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).slice(0, 15);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-10 animate-fadeInUp", children: [
      /* @__PURE__ */ jsx(HeroBanner, { items: allContentItems }),
      /* @__PURE__ */ jsx(ContinueContent, {}),
      trendingItems.length > 0 && /* @__PURE__ */ jsx(
        ContentCarousel,
        {
          title: "🔥 Trending Now",
          items: trendingItems,
      ...
      popularThisMonth.length > 0 && /* @__PURE__ */ jsx(
        ContentCarousel,
        {
      ...
      newReleases.length > 0 && /* @__PURE__ */ jsx(
        ContentCarousel,
        {
          title: "✨ New Releases",
          items: newReleases,
      ...
      filteredContent.podcasts.length > 0 && /* @__PURE__ */ jsx(
        ContentCarousel,
        {
      ...
      filteredContent.ebooks.length > 0 && /* @__PURE__ */ jsx(
        ContentCarousel,
        {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-h-screen", children: [
    ...
    /* @__PURE__ */ jsx(
      "main",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "container px-4 mx-auto", children: /* @__PURE__ */ jsx(Home, { initialData, selectedCategory }) })
      }
    )
  ] });
}
...
const BecomeCreatorPage = React__default.lazy(() => import("./become-creator-DMe1TvqT.js").then((module) => ({ default: module.BecomeCreatorPage })));
const SignInPage = React__default.lazy(() => import("./sign-in-Dy5qEItl.js").then((module) => ({ default: module.SignInPage })));
const SignUpPage = React__default.lazy(() => import("./sign-up-DlXBXqI5.js").then((module) => ({ default: module.SignUpPage })));
const ForgotPasswordPage = React__default.lazy(() => import("./forgot-password-PBr-96sn.js").then((module) => ({ default: module.ForgotPasswordPage })));
const ResetPasswordPage = React__default.lazy(() => import("./reset-password-CUfqMJwG.js").then((module) => ({ default: module.ResetPasswordPage })));
const VerifyEmailPage = React__default.lazy(() => import("./verify-email-C3u1q7-6.js").then((module) => ({ default: module.VerifyEmailPage })));
const AuthCallbackPage = React__default.lazy(() => import("./callback-B8xWwrfB.js").then((module) => ({ default: module.AuthCallbackPage })));
const QuickBitesPage = React__default.lazy(() => import("./quick-bites-GGKvAhq3.js").then((module) => ({ default: module.QuickBitesPage })));
const FollowedPage = React__default.lazy(() => import("./followed-BZXPgtVH.js").then((module) => ({ default: module.FollowedPage })));
const LibraryPage = React__default.lazy(() => import("./library-D21ofxhx.js").then((module) => ({ default: module.LibraryPage })));
const CommunityPage = React__default.lazy(() => import("./community-N55cFeJN.js").then((module) => ({ default: module.CommunityPage })));
const HistoryPage = React__default.lazy(() => import("./history-yyFAqMa3.js").then((module) => ({ default: module.HistoryPage })));
const CreatorProfilePage = React__default.lazy(() => import("./CreatorProfilePage-HfR8pbtK.js").then((module) => ({ default: module.CreatorProfilePage })));
const DashboardLayout = React__default.lazy(() => import("./index-C6AZzx-w.js").then((module) => ({ default: module.DashboardLayout })));
const DashboardOverviewPage = React__default.lazy(() => import("./overview-DZgEK-lQ.js").then((module) => ({ default: module.DashboardOverviewPage })));
const ContentPage = React__default.lazy(() => import("./index-CiRcPimP.js").then((module) => ({ default: module.ContentPage })));
const NewArticlePage = React__default.lazy(() => import("./article-C6zhYQgW.js").then((module) => ({ default: module.NewArticlePage })));
const NewBookPage = React__default.lazy(() => import("./book-BDY-XBYn.js").then((module) => ({ default: module.NewBookPage })));
const NewAudiobookPage = React__default.lazy(() => import("./audiobook-Cg9y49aK.js").then((module) => ({ default: module.NewAudiobookPage })));
const NewPodcastPage = React__default.lazy(() => import("./podcast-DLQxxHTY.js").then((module) => ({ default: module.NewPodcastPage })));
const EarningsPage = React__default.lazy(() => import("./index-BjUIHNxO.js").then((module) => ({ default: module.EarningsPage })));
const AppointmentsPage = React__default.lazy(() => import("./index-CBHd5lBq.js").then((module) => ({ default: module.AppointmentsPage })));
const AnalyticsPage = React__default.lazy(() => import("./index-iLfzPffk.js").then((module) => ({ default: module.AnalyticsPage })));
const SettingsPage = React__default.lazy(() => import("./index-DvNBwrA_.js").then((module) => ({ default: module.SettingsPage })));
const ReaderPage = React__default.lazy(() => import("./ReaderPage-DSvrm36L.js").then((module) => ({ default: module.ReaderPage })));
const PlayerPage = React__default.lazy(() => import("./PlayerPage-BXpxi_5t.js").then((module) => ({ default: module.PlayerPage })));
const SearchPage = React__default.lazy(() => import("./search-DfCClK19.js").then((module) => ({ default: module.default })));
...
const AboutPage = React__default.lazy(() => import("./about-I3zznZ8g.js").then((module) => ({ default: module.AboutPage })));
const SubscriptionPage = React__default.lazy(() => import("./index-CKp5Q9us.js").then((module) => ({ default: module.SubscriptionPage })));
const SubscriptionPaymentPage = React__default.lazy(() => import("./payment-Bhu2y74x.js").then((module) => ({ default: module.SubscriptionPaymentPage })));
const SubscriptionVerifyPage = React__default.lazy(() => import("./verify-BnGxUg65.js").then((module) => ({ default: module.SubscriptionVerifyPage })));
const SubscriptionConfirmPage = React__default.lazy(() => import("./confirm-Bor2rxle.js").then((module) => ({ default: module.SubscriptionConfirmPage })));
const CollectionPlayerPage = React__default.lazy(() => import("./CollectionPlayerPage-Drqd3g1W.js").then((module) => ({ default: module.CollectionPlayerPage })));
...
function MainLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-h-screen", children: [
    ...
    /* @__PURE__ */ jsx(
      "main",
      {
        className: `transition-all duration-300 will-change-transform ${isHomePage ? "pt-16" : "pt-14"} pb-20 ${isMobile ? "ml-0" : sidebarCollapsed ? "ml-16" : "ml-64"}`,
        children: /* @__PURE__ */ jsx("div", { className: `${isMobile ? "px-0" : "container px-4 mx-auto"}`, children: React__default.isValidElement(children) && React__default.cloneElement(children, { selectedCategory }) })
      }
    ),
...
function App() {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(LoadingFallback, {}), children: /* @__PURE__ */ jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsx(Route, { path: "/get-started", element: /* @__PURE__ */ jsx(Navigate, { to: "/signup", replace: true }) }),
...
const serverManifest = { "entry": { "module": "/assets/entry.client-CfBJ5VaK.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/query-cache-C18JZZse.js", "/assets/components-CmcuS0ao.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-DCDlAhfR.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/query-cache-C18JZZse.js", "/assets/components-CmcuS0ao.js", "/assets/auth-Bcu23vDA.js", "/assets/refresh-cw-D7JXRVhN.js", "/assets/pause-EEntwF1_.js", "/assets/list-DORbDLcn.js", "/assets/lock-Cln6DUFh.js", "/assets/zap-Bzsl1Z99.js"], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-CAN4yUw8.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/home-D-_rPzXq.js", "/assets/components-CmcuS0ao.js", "/assets/auth-Bcu23vDA.js", "/assets/query-cache-C18JZZse.js"], "css": [] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_-CleW3LcR.js", "imports": ["/assets/supabase-Ybu9b-xV.js", "/assets/home-D-_rPzXq.js", "/assets/auth-Bcu23vDA.js", "/assets/query-cache-C18JZZse.js"], "css": [] } }, "url": "/assets/manifest-4b06c622.js", "version": "4b06c622" };
