...
import { c as useTheme, d as detectUrduText, g as getTextLanguageClass, u as useAuth, e as formatDate, s as supabase } from "./server-build-CCRgnkMn.js";
import { FileText, RefreshCw, Minimize2, Maximize2, ExternalLink, Download, Loader2, AlertCircle, ArrowLeft, Menu, Settings, Bookmark, BookOpen, X, Minus, Plus, Sun, Moon, AlignLeft, Type, Highlighter, StickyNote, ChevronLeft, ChevronRight, Share, Heart, MessageSquare, Share2, Twitter, Facebook, Linkedin, Check, Copy, Send, ThumbsUp, Reply, ChevronUp } from "lucide-react";
import "node:stream";
import "isbot";
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-card border-b", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            error && /* @__PURE__ */ jsx("span", { className: "text-xs text-destructive bg-destructive/10 px-2 py-1 rounded", children: "Display Error" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", style: { height: isFullscreen ? "calc(100vh - 80px)" : "600px" }, children: [
          ...
          error ? /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-muted/20 p-8", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-medium mb-2", children: "Cannot Display PDF" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mb-6 text-center max-w-md", children: "Due to browser security restrictions, this PDF cannot be displayed inline. Please use one of the options below to view it." }),
        ...
        /* @__PURE__ */ jsx("div", { className: "px-4 py-2 bg-muted/30 border-t", children: /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground text-center", children: error ? 'Click "Open PDF in New Tab" to view the document' : "PDF loaded successfully. Use browser controls for navigation." }) })
      ]
    }
  );
}
function EReader({ book }) {
  ...
  const chapters = book.chapters && book.chapters.length > 0 ? book.chapters : book.content ? [
    {
      id: "main",
      title: "Full Content",
  ...
  useEffect(() => {
    ...
    if (contentRef.current) {
      const isUrduContent = detectUrduText(((_a2 = chapters[currentChapter]) == null ? void 0 : _a2.content) || "");
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              isPdf ? /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsx(PDFViewer, { fileUrl: book.file_url || "" }) }) : isHtml ? /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxs("div", { className: "w-full h-[calc(100vh-200px)]", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx(
                    "div",
                    {
                      className: getTextLanguageClass(((_c = chapters[currentChapter]) == null ? void 0 : _c.content) || ""),
              ...
              (!((_e = chapters[currentChapter]) == null ? void 0 : _e.content) || ((_f = chapters[currentChapter]) == null ? void 0 : _f.content.trim()) === "") && book.file_url && !isPdf && !isHtml && /* @__PURE__ */ jsxs("div", { className: "my-8 p-6 border rounded-lg text-center", children: [
