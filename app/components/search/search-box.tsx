...
export function SearchBox() {
  ...
  return (
    <div ref={searchRef} className="relative flex-1 max-w-2xl">
      ...
      {showResults && (
        <div className="absolute top-full mt-2 w-full md:w-full bg-popover border rounded-lg shadow-lg overflow-hidden z-50 left-0 right-0 mx-auto max-w-full">
            ...
            <div className="p-2">
              {suggestions.map((suggestion, i) => (
                ...
                >
                  ...
                  {suggestion.category && (
                    <span className="text-xs px-2 py-0.5 rounded-full bg-muted group-hover:bg-primary-foreground/20 group-hover:text-primary-foreground transition-colors flex-shrink-0">
                      {suggestion.category}
                    </span>
                  )}
                  {suggestion.count && (
                    <span className="hidden md:inline text-xs text-muted-foreground group-hover:text-primary-foreground/80 transition-colors flex-shrink-0">
