...
export function ContentCard({
  ...
  // Determine aspect ratio based on content type - consistent sizing for all
  const getAspectRatio = () => {
    // Use consistent 2/3 aspect ratio for all content types (standard book cover ratio)
    return "aspect-[2/3]";
  };
  ...
  return (
    ...
    >
      ...
      >
        <Bookmark
          className={`w-4 h-4 ${
            isBookmarked || (activeShelf && item.bookmarked)
              ? "fill-current"
              : ""
          }`}
        />
