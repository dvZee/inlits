...
export function ContentLayout({ 
  ...
  const [visibleSections, setVisibleSections] = useState(2); // Start with 2 sections for faster initial load
  ...
  useEffect(() => {
    ...
    observerRef.current = new IntersectionObserver(entries => {
      ...
      if (entry.isIntersecting) {
        ...
        setVisibleSections(prev => prev + 1); // Load 1 more section at a time for smoother loading
      }
    }, {
      rootMargin: '100px', // Reduced margin for more controlled loading
    });
