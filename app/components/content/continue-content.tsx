...
export function ContinueContent() {
      ...
      try {
        ...
        historyData?.forEach((item) => {
          ...
          if (item.content_type === "audiobook" && item.audiobooks) {
            content = Array.isArray(item.audiobooks)
              ? item.audiobooks[0]
              : item.audiobooks;
            type = "audiobook";
            ...
            content = Array.isArray(item.podcasts)
              ? item.podcasts[0]
              : item.podcasts;
            type = "podcast";
          }
          ...
          if (content) {
            ...
            items.push({
              ...
              thumbnail:
                content.cover_url ||
                "https://placehold.co/600x800?text=Content",
              ...
              creator: author
                ? {
                    ...
                    avatar:
                      author.avatar_url || "https://placehold.co/80x80?text=U",
  ...
  return (
    <ContentCarousel title="▶️ Continue Listening" items={continueItems} />
  );
}
