        ...
        {articles.map((article) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h2 className={`text-lg font-medium hover:text-primary transition-colors ${getTextLanguageClass(article.title)}`}>
                {article.title}
              </h2>
              <p className={`mt-1 text-sm text-muted-foreground line-clamp-2 ${getTextLanguageClass(article.excerpt)}`}>
                {article.excerpt}
              </p>
