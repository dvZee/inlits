              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0 space-y-4">
                  <div>
                    ...
                    <p className={`text-muted-foreground mt-2 line-clamp-2 ${getTextLanguageClass(audiobook.description)}`}>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <h4 className={`font-medium truncate ${getTextLanguageClass(chapter.title)}`}>
