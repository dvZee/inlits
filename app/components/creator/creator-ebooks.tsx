        ...
        {books.map((book) => (
          ...
          >
            ...
            <div className="flex-1 p-4">
              <div className="mb-2">
                <h3 className={`font-medium line-clamp-2 hover:text-primary transition-colors ${getTextLanguageClass(book.title)}`}>
                  {book.title}
                </h3>
                <p className={`text-sm text-muted-foreground mt-1 line-clamp-2 ${getTextLanguageClass(book.description)}`}>
                  {book.description}
                </p>
              </div>
