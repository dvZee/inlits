...
import { Settings, Users, BookOpen, MessageSquare, Star, Calendar, TrendingUp, Target } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <IntellectualIdentity stats={userStats} userId={user.id} isOwnProfile />
            <ProfileContributions userId={user.id} isOwnProfile />
          </div>
