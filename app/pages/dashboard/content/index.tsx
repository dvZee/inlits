                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className={`font-medium transition-colors hover:text-primary ${getTextLanguageClass(item.title)}`}>
                        {item.title}
                      </h3>
                    ...
                    {(item.excerpt || item.description) && (
                      <p className={`mt-1 text-sm text-muted-foreground line-clamp-2 ${getTextLanguageClass(item.excerpt || item.description || '')}`}>
                        {item.excerpt || item.description}
                      </p>
                    )}
